...
python navigation/data_collect_21.py --gpu_list '5' --run_type 'train' --data_split 14 &
python navigation/data_collect_21.py --gpu_list '5' --run_type 'train' --data_split 15 &
python navigation/data_collect_21.py --gpu_list '5' --run_type 'train' --data_split 16 &
python navigation/data_collect_21.py --gpu_list '6' --run_type 'train' --data_split 17 &
python navigation/data_collect_21.py --gpu_list '6' --run_type 'train' --data_split 18 &
python navigation/data_collect_21.py --gpu_list '6' --run_type 'train' --data_split 19 &
