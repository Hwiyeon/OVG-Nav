...
from goal_dist_pred.model_value_graph_0607 import TopoGCN_v2_1 as ValueModel
...
class Runner:
    ...
    def init_commonsense_candidate_room(self, goal_names, candidate_names):
        ...
        for i, goal_name in enumerate(goal_names):
            ...
            goal_category_room_feat[goal_name] = pred_words_feat
    ...
    def check_cand_node_edge(self, cur_node, pano_rgb, pos, rot):
        ...
        for i, angle in enumerate(cand_angle):
            ...
            if nearest_node_dist < self.graph_map.max_edge_length and free_cand_nodes[i] == 1:
                ...
                self.graph_map.update_node_clip_feat(cand_node, cand_image_feat, cur_heading_idx)
    ...
    def get_value_graph(self):
        ...
        node_features = torch.zeros([graph_size, self.args.vis_feat_dim], dtype=torch.float)
        node_goal_features = torch.zeros([graph_size, self.args.vis_feat_dim], dtype=torch.float)
        node_info_features = torch.zeros([graph_size, 5], dtype=torch.float)
    ...
    def update_cand_node_to_graph(self, cur_node, cand_nodes):
        ...
        for cand_node_info in cand_nodes:
            ...
            self.graph_map.update_node_cm_score(cand_node,
    ...
    def do_time_steps(self, data_idx):
        ...
        while True:
            ...
            # cm_score, arg_cm_score = self.common_sense_model.text_image_score(self.goal_place_text_feat,
