...
parser.add_argument("--data_split_max", type=int, default=31)
parser.add_argument("--save_dir", type=str, default="/disk4/hwing/Dataset/cm_graph/{}/0630/relative_pose_step_by_step_pano")
...
import data_collect_runner_step_by_step_depth as runner
