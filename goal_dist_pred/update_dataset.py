...
parser.add_argument('--gpu', type=str, default='0, 1', help="which gpu devices to use")
...
from dataloader_batch_graph_data_0607 import Batch_traj_DataLoader_pano as Batch_traj_DataLoader
...
def main_0():
    ...
    # with open('/data1/hwing/Projects/offline_objgoal/modules/comet_relation/gibson_goal_obj_text_clip_feat.pkl',
    #           'rb') as f:
    #     goal_text_clip_feat = pickle.load(f)
    # goal_text_clip_feat = goal_text_clip_feat.cpu()
